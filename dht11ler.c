...
/*
 * Recebe como argumentos dois apontadores para inteiros de 8 bits.
 ...
 * Retorna diferente de 0 se os valores forem validos, 
 * retorna              0 se houve erro na leitura.
 */
